 ...
 * DAY PHOTO: real close-up of the white track tucked under the soffit/fascia.
 */
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <figure className="overflow-hidden rounded-2xl bg-white shadow-card">
          <MediaFrame
            ...
            alt="Daytime close-up of the white permanent lighting track tucked under the soffit and along the fascia, matched to the trim"
            aspect="photo"
